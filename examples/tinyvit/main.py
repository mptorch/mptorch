...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Simple Vision Transformer from Scratch"
    )
    ...
    parser.add_argument(
        "--n_classes", type=int, default=10, help="number of classes in the dataset"
    )
    parser.add_argument(
        "--n_workers", type=int, default=4, help="number of workers for data loaders"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="./outputs",
        help="path to store training graphs and tsne plots",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="number of heads to use in Multi-head attention",
    )
    ...
    parser.add_argument(
        "--model_path", type=str, default="./model", help="path to store trained model"
    )
    parser.add_argument(
