...
def test_scaling_format_deduction():
    ...
    formats = QAffineFormats(
        fwd_mac=fp_format,
        bwd_mac=fp_format,
        input_quant=(fp_format, "RNE"),
        output_quant=(fp_format, "RNE"),
        weight_quant=(fp_format, "RNE"),
        bias_quant=(fp_format, "RNE"),
        grad_quant=(fp_format, "RNE"),
    )
...
def test_qlinear_custom_mm_scaled(device, exp_1, man_1, exp_2, man_2):
    ...
    formats_q = QAffineFormats(
        weight_quant=(fp_format_1, "RNE"),
        grad_quant=(fp_format_2, "RNE"),
        input_quant=(fp_format_1, "RNE"),
        use_scaling=True,
    )
