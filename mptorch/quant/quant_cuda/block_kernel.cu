...
// quantize a float into a block floating point format with
// [man_bits] mantissa bits (wl - 1) using stochastic rounding
...
// quantize a float into a block floating point format with
// [man_bits] mantissa bits (wl - 1) using round to nearest
