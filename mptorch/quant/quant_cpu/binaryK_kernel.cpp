...
void binaryK_kernel(float *a, float *o, int size,
...
void binaryK_kernel(float *a, int *r, float *o, int size,
                    ...
                    SubnormalsMode subnormals_mode)
{
    ...
    std::function<float(float, uint32_t)> quantizer = [man_bits, exp_bits, bias, is_signed, prng_bits, saturation_mode, subnormals_mode](float x, uint32_t rv)
    {
