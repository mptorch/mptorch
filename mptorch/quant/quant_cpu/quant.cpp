                               ...
                               bool compensated)
{
  ...
  fp_mm_cpu(c, a, b, man_add, exp_add, man_mul, exp_mul, man_add, exp_add,
...
void float_quantize_nearest_bmm(Tensor a, Tensor b, Tensor c, int M, int N,
                                ...
                                bool compensated)
{
  float_quantize_nearest_mm(a, b, c, M, N, K, man_add, exp_add, man_mul,
                                   ...
                                   bool compensated)
{
  ...
  int64_t subnormal_mode = subnormals
                               ? static_cast<int64_t>(SubnormalsMode::SUBNORMALS)
                               : static_cast<int64_t>(SubnormalsMode::NORMALS);
  fp_mm_cpu(c, a, b, man_fma, exp_fma, man_fma, exp_fma, man_fma, exp_fma,
            static_cast<int64_t>(RoundMode::RNE), subnormal_mode, saturate,
...
void float_quantize_nearest_bmm_fma(Tensor a, Tensor b, Tensor c, int M, int N,
                                    ...
                                    bool compensated)
{
  float_quantize_nearest_mm_fma(a, b, c, M, N, K, man_fma, exp_fma,
...
void float_quantize_stochastic_bmm(Tensor a, Tensor b, Tensor c, int M, int N,
                                   ...
                                   bool saturate)
{
  float_quantize_stochastic_mm(a, b, c, M, N, K, man_add, exp_add, rbits_add,
                               man_mul, exp_mul, rbits_mul, subnormals,
                               saturate);
}
...
void float_quantize_stochastic_bmm_fma(Tensor a, Tensor b, Tensor c, int M,
                                       ...
                                       bool saturate)
{
  float_quantize_stochastic_mm_fma(a, b, c, M, N, K, man_fma, exp_fma,
                                     ...
                                     int fl_mul, bool symmetric)
{
  ...
  (void)N;
  (void)K;
  fxp_mm_cpu(c, a, b, wl_add, fl_add, wl_mul, fl_mul, wl_add, fl_add,
...
{
  fixed_point_quantize_nearest_mm(a, b, c, M, N, K, wl_add, fl_add, wl_mul,
                                  fl_mul, symmetric);
}
                                         ...
                                         bool symmetric)
{
  ...
  (void)N;
  (void)K;
  fxp_mm_cpu(c, a, b, wl_fma, fl_fma, wl_fma, fl_fma, wl_fma, fl_fma,
...
void fixed_point_quantize_nearest_bmm_fma(Tensor a, Tensor b, Tensor c, int M,
                                          ...
                                          bool symmetric)
{
  fixed_point_quantize_nearest_mm_fma(a, b, c, M, N, K, wl_fma, fl_fma,
                                      symmetric);
}
...
void fixed_point_quantize_stochastic_bmm(Tensor a, Tensor b, Tensor c, int M,
                                         ...
                                         bool symmetric)
{
  fixed_point_quantize_stochastic_mm(a, b, c, M, N, K, wl_add, fl_add, wl_mul,
                                     fl_mul, symmetric);
}
...
void fixed_point_quantize_stochastic_bmm_fma(Tensor a, Tensor b, Tensor c,
                                             ...
                                             int fl_fma, bool symmetric)
{
  fixed_point_quantize_stochastic_mm_fma(a, b, c, M, N, K, wl_fma, fl_fma,
                                         symmetric);
}
                                 ...
                                 int binades_mul_u, bool saturate)
{
  ...
  (void)N;
  (void)K;
  superfp_mm_cpu(c, a, b, man_add, exp_add, man_mul, exp_mul, man_add,
...
void superfp_quantize_nearest_bmm(Tensor a, Tensor b, Tensor c, int M, int N,
                                  ...
                                  int binades_mul_u, bool saturate)
{
  superfp_quantize_nearest_mm(a, b, c, M, N, K, man_add, exp_add, man_mul,
                                     ...
                                     bool saturate)
{
  ...
  (void)N;
  (void)K;
  superfp_mm_cpu(c, a, b, man_fma, exp_fma, man_fma, exp_fma, man_fma,
...
void superfp_quantize_nearest_bmm_fma(Tensor a, Tensor b, Tensor c, int M,
                                      ...
                                      bool saturate)
{
  superfp_quantize_nearest_mm_fma(a, b, c, M, N, K, man_fma, exp_fma,
