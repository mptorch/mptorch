...
// binaryK formats, fused mac, in binary32: the float32, float16 and bfloat16
// kernels of custom_matmul_binaryK_fma and its mixed-format twin.
// custom_matmul_binaryK_fma_f64.cu holds the same two ops' binary64 kernels.
//
