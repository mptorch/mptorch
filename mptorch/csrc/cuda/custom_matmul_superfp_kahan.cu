...
namespace mptorch::gemm_cuda
{
    ...
    template void CudaBackend::launch_accumulated_as<float, AccumulateAlgorithm::KAHAN, SuperfpSplitArgs>(
        const GemmShape &, const AccumulateArgs<SuperfpSplitArgs> &, const CudaBackend::LaunchContext &);
    template void CudaBackend::launch_accumulated_as<float, AccumulateAlgorithm::KAHAN, SuperfpFusedArgs>(
