...
// is not. Flat by design -- see dev/gemm_roadmap.md item 6.
...
// but role-specific width, not folded into BinaryKParams) -- only the
// round-to-nearest-even bit-twiddling constants precompute away.
